...
$(function() {
	$(".type-text").typed({
		strings:["<br> ^1250Hello, world! No, wait! Don't panic! You've come to the right place.<br><br>I'm Brandon Choi.<br> ^800Developer, writer, photographer.<br><br> ^500Press 'ENTER' to learn more about me and what I do.<br><br> ^100<span id='start'>START</span>  "],
		typeSpeed: 35,
	});
});
