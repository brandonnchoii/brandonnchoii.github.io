...
$(function() {
	$(".type-text").typed({
		strings:["<br> ^1250Hi, I'm Brandon.<br> ^600Developer, writer, photographer.<br><br> ^600Press 'ENTER' to learn more about me and what I do.<br><br> ^100<span id='start'>START</span>  "],
		typeSpeed: 35,
	});
});
